...
var dairyId = document.getElementById("dairyId").value;
    ...
    $(function () {
            $('#saleStartDate, #saleEndDate, #shiftDate, #memberPassbookStartDate, #memberPassbookEndDate, #balanceSheetStartDate, #balanceSheetEndDate, #cmSubsidiaryEndDate, #cmSubsidiaryStartDate, #tdate, #sdate, #sdateCust, #tdateCust, #sdateProfit, #tdateProfit, #fromdate,#todate').datetimepicker({
            format: 'DD-MM-YYYY'
        });
    });
