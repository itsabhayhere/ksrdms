...
//dd($previousbal);*/
        ...
        $latestTransaction = $allTransactions->sortByDesc('id')->first();
        //$lastCurrentBalance = str_replace(' cr', '', $latestTransaction->currentBalance ?? '0.00');
        ...
        $latestTransaction1 = $allTransactions1->sortByDesc('id')->first();
    ...
    public function fetchPreviousTransactions($dairy, $partyCode, $startDate)
    {
        ...
        $latestTransactionp = $allTransactionsp->sortByDesc('id')->first();
