              ...
              <table border="0" cellpadding="0" cellspacing="0" class="brdBottomPadd-two" id="templateContainer" width="100%">
                ...
                <tr>
                  ...
                  <td class="bodyContent" valign="top" mc:edit="welcomeEdit-02">
                    ...
                    <h1><strong>Welcome to {{$sysName}} <br>

                    you are now connected with us. </strong></h1>



                    <h3>Thanks for joining our dairy. You will be notify by emails about any activity in dairy.
