        ...
        <form method="post" id="regForm" action="{{url('/editMemberInfoSubmit')}}">
            ...
            <div class="col-sm-6">
                    ...
                    <div class="col-sm-6" id="fid" style="{{ $member_info[0]->is_andtodya == 'Yes'  ? '' : 'display:none;' }}">
                        ...
                        <input placeholder="Verified Income"  name="Verified_income" id="Verified_income" class="form-control" value="{{ $member_info[0]->Verified_income }}">
