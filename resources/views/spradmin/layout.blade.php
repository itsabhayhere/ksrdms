...
<body>
    @php
        if(isset(Auth::user()->name)) $brand = Auth::user()->name; elseif(Session::get('loginUserType') == 'dairy') 
        $brand = Session::get('loginUserInfo')->userName; elseif(Session::get('loginUserType') == 'user') $brand = Session::get('loginUserInfo')->userName;
        else $brand = "DMS";
    @endphp
            ...
            <nav class="navbar navbar-default" role="navigation" style="margin-bottom: 52px;">
                ...
                <div class="navbar-header">
                    <div class="brand-wrapper">
                        ...
                        <div class="brand-name-wrapper">
                            <a class="navbar-brand" href="url('sa')">
                ...
                <div class="side-menu-container">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dairySetup"><a href="{{url('sa/dairysetupwizard')}}"><span class="fa fa-plus-square"></span> New Dairy</a></li>
                        <li class="dairyList"><a href="{{url('sa/dairyList')}}"><span class="fa fa-list-alt"></span> Dairy List</a></li>
                        <li class="milkPlants"><a href="{{url('sa/milkPlants')}}"><span class="fa fa-list-alt"></span> Milk Plants</a></li>
                        <li class="pricePlan"><a href="{{url('sa/pricePlan')}}"><span class="fa fa-list-alt"></span> Subscription Plan</a></li>
                        <li class="appSettings"><a href="{{url('sa/appSettings')}}"><span class="fa fa-list-alt"></span> App Settings</a></li>
                        {{-- <li class="payment"><a href="{{url('sa/pay')}}"><span class="fa fa-list-alt"></span>Pay</a></li> --}}
