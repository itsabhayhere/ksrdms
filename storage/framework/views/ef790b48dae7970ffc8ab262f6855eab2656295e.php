...
<div class="clearfix">
    ...
    <script>
        ...
        function openMemberDetail(type){
            switch(type){
                case "total":{
                    window.location = "<?php echo e(url('memberDetailDash?type=total')); ?>";
                    break;
                }
                case "active":{
                    window.location = "<?php echo e(url('memberDetailDash?type=active')); ?>";
                    break;
                }
                case "inactive":{
                    window.location = "<?php echo e(url('memberDetailDash?type=inactive')); ?>";
                    break;                    
                }
                case "credit":{
                    window.location = "<?php echo e(url('memberDetailDash?type=credit')); ?>";
                    break;
                }
                case "debit":{
                    window.location = "<?php echo e(url('memberDetailDash?type=debit')); ?>";
                    break;                    
                }
                default:
            }
        ...
        function openCustomerDetail(type){
            switch(type){
                case "credit":{
                    window.location = "<?php echo e(url('customerDetailDash?type=credit')); ?>";
                    break;
                }
                case "debit":{
                    window.location = "<?php echo e(url('customerDetailDash?type=debit')); ?>";
                    break;                    
                }
                default:
            }
        ...
        function openSuppDetail(type){
            switch(type){
                case "credit":{
                    window.location = "<?php echo e(url('suppDetailDash?type=credit')); ?>";
                    break;
                }
                case "debit":{
                    window.location = "<?php echo e(url('suppDetailDash?type=debit')); ?>";
                    break;                    
                }
                default:
            }
    ...
    function setMembersData(members){
        if(members.countMembers == 0){
            $("#member-overlay").show().html("No members found. please <a href='<?php echo e(url('memberSetupForm')); ?>' > add new members </a> now.");
            console.log("sdf");
        }
