 ...
 -->
					...
					<div class="clearfix">
						...
						<div class="col-md-2"> 
							...
							<input type="number" class="form-control" onkeyup="getSaleAmount('member')" id="mQuantity" placeholder="Enter Quantity" name="quantity" tabindex="25" step="0.1" required autocomplete="off">
						...
						<div class="col-md-2"> 
							...
							<input type="text" readonly="readonly" class="noinput"  id="mRate" name="rate" style="width: 100%;line-height: 30px;color: #d00606; padding-left:0;font-weight:bold" autocomplete="off">
						...
						<div class="col-md-2"> 
							...
							<input type="number" readonly="readonly" class="form-control rupee" id="mAmount" name="amount" min="0" required autocomplete="off">
						...
						<div class="col-md-2">
							...
							<input type="number" class="form-control"  id="mDiscount" name="discount" value="0" tabindex="26" onchange="getFinalAmount('member')" min="0" required autocomplete="off">
						...
						<div class="col-md-5 mt-5">
							...
							<input type="text" class="form-control" id="mRemark" value="" name="remark" tabindex="27" row="2" placeholder="(Optional)" maxlength="300" autocomplete="off">
						...
						<div class="col-md-2 text-center">	
							...
							<button type="submit" class="btn btn-primary SubmitBtn" tabindex=30>Submit</button>
