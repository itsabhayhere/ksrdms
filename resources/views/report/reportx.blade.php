        ...
        <div class="">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4 pt-20">
                    ...
                    <select id="reportSelect" onchange="getReportForm(this.value);" class="form-control selectpicker" data-live-search="true" title="Select Report">
                        ...
                        <option value="memStatementDetail" @if($repType=="memStatementDetail" ) selected @endif>Member Account Statement Detail</option>
                ...
                <div class="col-md-8 bl-1 p-0">
                    ...
                    <div id="memberPassbook" class="reportElm" style="display: none;">
                        ...
                        <div class="col-sm-3">
                            <label> &nbsp; </label>
                            <input type="button" name="getSaleData" value="Get" onclick="getMemberFilterCurrentPassbookValue('Asfasf');" id="getSaleData" class="getSaleData form-control getButton">
                        </div>
                    ...
                    <div id="cmSubsidiary" class="reportElm" style="display: none;">
                        ...
                        <div class="col-sm-6">
                            ...
                            <select id="reportSelectcmSubsidiary"  class="form-control selectpicker" data-live-search="true" title="Select Report" req>
                        ...
                        <div id="Reporttype" class="col-sm-6">
                            ...
                            <select id="select_report"  onchange="gettypedata();" class="form-control selectpicker" data-live-search="true" title="Select Report">
                    ...
                    <div class="reportElm clearfix dnone" id="memStatement">
                        ...
                        <div class="col-sm-3 col-md-3">
                            <label>From</label>
                            <input type="text" class="form-control" id="sdate" placeholder="From" value="{{date(" d-m-Y ")}}" name="fromdate" autocomplete="off">
                        </div>

                        <div class="col-sm-3 col-md-3">
                            <label>To</label>
                            <input type="text" class="form-control" id="tdate" placeholder="To" value="{{date(" d-m-Y ")}}" name="todate" autocomplete="off">
                        </div>
                    ...
                    <div class="reportElm clearfix dnone" id="memStatementDetail">
                        ...
                        <div class="col-sm-3">
                            <label>Member Name</label>
                            <span class="memberNameErrorMessage errorMessage" id="memberNameErrorMessage"></span>
                            <input class="form-control" id="memberNameSt2" name="partyName" required="true" data-name="name">
                        </div>

                        <div class="col-sm-3 col-md-3">
                            <label>From</label>
                            <input type="text" class="form-control" id="sdate2" placeholder="From" value="{{date(" d-m-Y ")}}" name="fromdate" autocomplete="off">
                        </div>

                        <div class="col-sm-3 col-md-3">
                            <label>To</label>
                            <input type="text" class="form-control" id="tdate2" placeholder="To" value="{{date(" d-m-Y ")}}" name="todate" autocomplete="off">
                        </div>
                        ...
                        <div class="col-sm-3">
                            <label> &nbsp; </label>
                            <input type="button" name="getStatementBtn" value="Get" onclick="getMemStatementReportDetail(this);" id="getStatementBtn" class="getStatementBtn form-control getButton">
                        </div>
                    ...
                    <div class="reportElm clearfix dnone" id="custSalseReport">
                        <div class="col-sm-12 col-md-12">
                            ...
                            <div class="col-sm-3 col-md-3">
                                <label>From</label>
                                <input type="text" class="form-control" id="sdateCust" placeholder="From" value="{{date(" d-m-Y ")}}" name="fromdate" autocomplete="off">
                            </div>

                            <div class="col-sm-3 col-md-3">
                                <label>To</label>
                                <input type="text" class="form-control" id="tdateCust" placeholder="To" value="{{date(" d-m-Y ")}}" name="todate" autocomplete="off">
                            </div>
                    ...
                    <div class="reportElm clearfix dnone" id="profitLoss">
                        <div class="col-sm-12 col-md-12 p-0">
                            ...
                            <div class="col-sm-3 col-md-3">
                                <label>From</label>
                                <input type="text" class="form-control" id="sdateProfit" placeholder="From" value="{{date(" d-m-Y ")}}" name="fromdate" autocomplete="off">
                            </div>

                            <div class="col-sm-3 col-md-3">
                                <label>To</label>
                                <input type="text" class="form-control" id="tdateProfit" placeholder="To" value="{{date(" d-m-Y ")}}" name="todate" autocomplete="off">
                            </div>
                    ...
                    <div class="reportElm clearfix dnone" id="supplier">
                        <div class="col-sm-12 col-md-12 p-0">
                            ...
                            <div class="col-sm-3 col-md-3">
                                ...
                                <input type="text" name="mcode" id="suppliercode" class="form-control" placeholder="Supplier Code" data-name="code">
                            </div>

                            <div class="col-sm-3 col-md-3">
                                <label>Supplier Name</label>
                                <input type="text" name="mcode" id="supplierName" class="form-control" placeholder="Supplier Name" data-name="name">
                            </div>

                            <div class="col-sm-3 col-md-3">
                                <label> From </label>
                                <input type="text" name="from" id="fromdate" class=" form-control" value="{{date('d-m-Y')}}" autocomplete="off">
                            </div>

                            <div class="col-sm-3 col-md-3">
                                <label> To </label>
                                <input type="text" class="form-control " id="todate" name="todate" value="{{date('d-m-Y')}}" autocomplete="off">
                            </div>

                            <div class="col-sm-3">
                                <label> &nbsp; </label>
                                <input type="button" value="Get" onclick="getSupplier(this);" id="getSupplierbtn" class=" form-control getButton">
                            </div>
