...
<html lang="zxx">
   <head>
    ...
    <link href="//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
      ...
      {{-- <link href="http://ksrservices.com/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" /> --}}
      <link href="http://ksrservices.com/css/style.css" rel="stylesheet" type="text/css" media="all" />
      <!-- //custom-theme -->
      <!-- font-awesome-icons -->
      <link href="http://ksrservices.com/css/font-awesome.css" rel="stylesheet">
      <!-- //font-awesome-icons -->
   ...
   <body>
            ...
            <div class="top_header_agile_info_w3ls">
               <nav class="navbar navbar-default">
                  <div class="navbar-header navbar-left">
                     ...
                     <h1><a class="navbar-brand" href="index.html"><img src="http://ksrservices.com/images/ksr.png" width="143" height="99"></a></h1>
                  </div>
                  <!-- Collect the nav links, forms, and other content for toggling -->
                  <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                     <div class="w3l_header_left">
                        <ul>
                           <li > <a href="about.html"><i class="fa fa-info-circle" aria-hidden="true"></i><span data-letters="About Us">About Us</span></a></li>
                     ...
                     <div id="m_nav_container" class="m_nav wthree_bg">
                        <nav class="menu menu--sebastian">
                           <ul id="m_nav_list" class="m_nav menu__list">
                              ...
                              <li class="m_nav_item" id="moble_nav_item_3"> <a href="membership.html" class="link link--kumya"><i class="fa fa-info-circle" aria-hidden="true"></i><span data-letters="">Membership</span></a></li>
                              <li class="m_nav_item" id="moble_nav_item_4"> <a href="features.html" class="link link--kumya"><i class="fa fa-picture-o" aria-hidden="true"></i><span data-letters="">Features</span></a></li>
                              <li class="m_nav_item" id="moble_nav_item_6"> <a href="support.html" class="link link--kumya"><i class="fa fa-envelope-o" aria-hidden="true"></i><span data-letters="">Support & Help</span></a></li>
                           </ul>
                        </nav>
                     </div>
                  </div>
      ...
      <div class="banner-bottom">
         <div class="container">
            <h2 class="title-w3-agileits inner">Single Page</h2>
            ...
            <div class="agile_about_grids">
                  ...
                  <div class="agileits_recent_posts">
                     ...
                     <div class="agileits_recent_posts_grid">
                        <div class="agileits_recent_posts_gridl">
                           <img src="http://ksrservices.com/images/7.jpg" alt=" " class="img-responsive" />
                        </div>
                     ...
                     <div class="agileits_recent_posts_grid">
                        <div class="agileits_recent_posts_gridl">
                           <img src="http://ksrservices.com/images/8.jpg" alt=" " class="img-responsive" />
                        </div>
                        <div class="agileits_recent_posts_gridr">
                     ...
                     <div class="agileits_recent_posts_grid">
                        <div class="agileits_recent_posts_gridl">
                           <img src="http://ksrservices.com/images/9.jpg" alt=" " class="img-responsive" />
                        </div>
                        <div class="agileits_recent_posts_gridr">
                     ...
                     <div class="agileits_recent_posts_grid">
                        <div class="agileits_recent_posts_gridl">
                           <img src="http://ksrservices.com/images/10.jpg" alt=" " class="img-responsive" />
                        </div>
                        <div class="agileits_recent_posts_gridr">
                  ...
                  <div class="agileits_twitter_posts">
                     ...
                     <ul>
                        ...
                        <li><i class="fa fa-twitter" aria-hidden="true"></i> 03 day ago <span>Qon numquam <a href="#">http://gf.ds/gre21#</a>
                           eius modi tempora incidunt ut labore et
                           <a href="#">http://gf.ds/gre21#</a>quo nulla.</span>
                        </li>
                     </ul>
                  </div>
               ...
               <div class="col-md-8 agile_single_right">
                  ...
                  <h3>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sit amet lectus turpis. Donec maximus odio nec odio.</h3>
                  <div class="w3_comments_bottom">
                     <img src="http://ksrservices.com/images/6.jpg" alt=" " class="img-responsive" />
                     <p><i>Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, 
                        cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime 
                        placeat facere possimus.</i>Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet
                        ut et voluptates repudiandae sint et molestiae non recusandae. Itaque earum rerum hic tenetur a sapiente delectus,
                        ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat.Ut enim ad
                  ...
                  <div class="agile_single_right_grids">
                     <div class="col-md-6 agile_single_right_grid">
                        <p>"On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by
                           the charms of pleasure of the moment.<span>In a free hour, when our power of 
                           choice is untrammelled and when nothing prevents our being able 
                           to do what we like best.</span>
                        </p>
                     </div>
                     <div class="col-md-6 agile_single_right_grid">
                        <img src="http://ksrservices.com/images/5.jpg" alt=" " class="img-responsive">
                     </div>
                     <div class="clearfix"> </div>
                  </div>
                  <div class="agile_single_right_grids_two">
                     <div class="col-md-6 agile_single_right_grids_two_grid">
                        <img src="http://ksrservices.com/images/3.jpg" alt=" " class="img-responsive">
                        <p>cum soluta nobis est eligendi</p>
                     </div>
                     <div class="col-md-6 agile_single_right_grids_two_grid">
                        <h4> <i class="fa fa-quote-left" aria-hidden="true"></i> Quis autem vel eum iure reprehenderit qui in ea voluptate velit
               ...
               <div class="w3agile_comments">
                  ...
                  <div class="comments-grid">
                     <div class="w3agile_grid_left">
                        <img src="http://ksrservices.com/images/c1.png" alt=" " class="img-responsive">
                     </div>
                     <div class="w3agile_grid_right">
                        <h3><a href="#">Adam Smith</a></h3>
                        <h5><span class="fa fa-calendar" aria-hidden="true"></span> On 25th Apr, 2017</h5>
                        <p>Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui
                           dolorem eum fugiat quo voluptas nulla pariatur.
                        </p>
                        <div class="reply">
                           <a href="#">Reply</a>
                  ...
                  <div class="comments-grid">
                     <div class="w3agile_grid_left">
                        <img src="http://ksrservices.com/images/c2.png" alt=" " class="img-responsive">
                     </div>
                     <div class="w3agile_grid_right">
                        <h3><a href="#">James Rick</a></h3>
                        <h5><span class="fa fa-calendar" aria-hidden="true"></span> On 26th May, 2017</h5>
                        <p>Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui
                           dolorem eum fugiat quo voluptas nulla pariatur.
                        </p>
                        <div class="reply">
            ...
            <div class="col-md-4 w3agile_footer_grid">
               ...
               <ul class="w3agile_footer_grid_list">
                  ...
                  <li>Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis voluptatibus.
                     <span><i class="fa fa-twitter" aria-hidden="true"></i> 03 days ago</span>
                  </li>
               </ul>
            </div>
            <div class="col-md-3 w3agile_footer_grid">
      ...
      <div class="agileinfo_copy_right">
         <div class="container">
            <div class="agileinfo_copy_right_left">
               <p>© 2018 KSR Services. All rights reserved</a></p>
            </div>
