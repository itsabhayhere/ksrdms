        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" style="padding:5px 15px">
                ...
                <div class="col-md-7 col-sm-12">
                    ...
                    <div class="r-font-12" style="font-weight: 100;">
                        ...
                        <div class="text-center">
                            <div>
                                <a href="{{url('buy')}}" class="btn btn-success btn-register btn-lg" style="background: #66a711;border-color: #5e9416;">Register For Free</a>
                            </div>
                            <div>
                ...
                <div class="col-md-5 col-sm-12">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ url('/my-login-submit') }}" id="login-form" onsubmit="event.preventDefault();userLogin();">
                    ...
                    <form action="" class="form-horizontal dnone" id="login-form-otp">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <span class="MobileNumberErrorMessage errmsg" id="MobileNumberErrorMessage"> </span>
                                <input id="MobileNumberOtp" max="10" type="number" class="form-control" name="username" value="{{ old('username') }}" required
                                    autofocus>
                            </div>
                        </div>

                        <div class="dnone otp-field form-group{{ $errors->has('password') ? ' has-error' : '' }}">
