    ...
    <div class="">
        <div class="fcard margin-fcard-1 clearfix">
            ...
            <div class="">
                ...
                <div class="heading clearfix">
                    <div class="fl">
                        <h3 class="m-0">Report Generate </h4>
                            <hr class="m-0">
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4 pt-20">
                        ...
                        <input type="hidden" form="form1" id="status" name="status" value="true">
                        <!-- select list for select report type -->
                        <label> Select Report Type </label>
                        <select id="reportSelect" onchange="getReportForm(this.value);" class="form-control selectpicker"
                            data-live-search="true" title="Select Report">
                            ...
                            <option value="shiftSummary" @if($repType == "shiftSummary") selected @endif>Shift Summary
                            </option>
                            <option value="ledger" @if($repType == "ledger") selected @endif>Ledger</option>
                            <option value="memberPassbook" @if($repType == "memberPassbook") selected @endif>Member Passbook
                            </option>
                            <option value="memStatement" @if($repType == "memStatement") selected @endif>Member Account
                                Statement</option>
                            <option value="memStatementDetail" @if($repType == "memStatementDetail") selected @endif>Member
                                Account Statement Detail</option>
                            <option value="custSalseReport" @if($repType == "custSalseReport") selected @endif>Customer
                                Account Statement</option>
                            {{-- <option value="balanceSheet" @if($repType=="balanceSheet" ) selected @endif>Balance Sheet
                            </option> --}}
                            <option value="payemntRegister" @if($repType == "payemntRegister") selected @endif>Payment
                                Register</option>
                            <option value="cmSubsidiary" @if($repType == "cmSubsidiary") selected @endif>CM Subsidiary
                            </option>
                            <option value="profitLoss" @if($repType == "profitLoss") selected @endif>Profit Loss Report
                            </option>
                            <option value="supplier" @if($repType == "supplier") selected @endif>Supplier </option>
                        </select>
                    ...
                    <div class="col-md-8 bl-1 p-0">
                        ...
                        <div id="sales" class="sales reportElm clearfix" style="display:none;">
                            <div class="clearfix mb-10">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="saleStartDate" id="saleStartDate"
                                        class="saleStartDate form-control" value="{{date(" d-m-Y ")}}">
                                </div>
                                <div class="col-sm-6">
                                    <label> End Date </label>
                                    <input type="text" name="saleEndDate" id="saleEndDate" class="saleEndDate form-control"
                                        value="{{date(" d-m-Y ")}}">
                                </div>
                                ...
                                <div class="col-sm-12 pt-10 pb-10">
                                    <div class="col-sm-3 p-0">
                                        <label class="rdolb lh-25"><input type="radio" name="saleType" onclick="" value=""
                                                checked>All</label>
                                    </div>
                                    <div class="col-sm-3 p-0">
                                        <label class="rdolb lh-25"><input type="radio" name="saleType" onclick=""
                                                value="local_sale">Local Sale</label>
                                    </div>
                                    <div class="col-sm-3 p-0">
                                        <label class="rdolb lh-25"><input type="radio" name="saleType" onclick=""
                                                value="product_sale">Product Sale</label>
                                    </div>
                                    <div class="col-sm-3 p-0">
                                        <label class="rdolb lh-25"><input type="radio" name="saleType" onclick=""
                                                value="plant_sale">Plant Sale</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12 pt-10 pb-10">
                                    <div class="col-sm-3 p-0">
                                        <label class="rdolb lh-25"><input type="radio" name="userType" onclick="" value=""
                                                checked>All</label>
                                    </div>
                                    <div class="col-sm-3 p-0">
                                        <label class="rdolb lh-25"><input type="radio" name="userType" onclick=""
                                                value="customer">Customer</label>
                                    </div>
                                    <div class="col-sm-3 p-0">
                                        <label class="rdolb lh-25"><input type="radio" name="userType" onclick=""
                                                value="member">Members</label>
                                    </div>
                                    <div class="col-sm-3 p-0">
                                        <label class="rdolb lh-25"><input type="radio" name="userType" onclick=""
                                ...
                                <div class="col-sm-6 pt-10">
                                    <label> &nbsp; </label>
                                    <input type="button" name="getSaleData" value="Get" onclick="getSaleCurrentValue();"
                        ...
                        <div id="memberList" class="col-sm-12 reportElm p-0 clearfix" style="display: none;">
                            <div class="col-md-12 mb-20 p-0 clearfix">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input class="form-control" id="memberNameStL" name="partyName" required="true"
                                        data-name="name">
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <label> &nbsp; </label>
                                    <input type="button" name="getMemberData" value="Get"
                                        onclick="getMemberFilterCurrentValue();" id="getMemberData"
                                        class="getMemberData form-control getButton">
                                </div>
                            </div>
                        ...
                        <div id="shiftSummary" class="reportElm" style="display: none;">
                            <div class="mb-20 clearfix">
                                <div class="col-sm-4 col-md-4 col-lg-3">
                                    <label> Date </label>
                                    <input type="text" name="shiftDate" id="shiftDate" class="shiftDate form-control "
                                        value="{{date(" d-m-Y ")}}">
                                </div>
                                <div class="col-sm-4 col-md-4 col-lg-3">
                                    <label> Shift </label>
                                ...
                                <div class="col-sm-4 col-md-4 col-lg-3">
                                    <label> &nbsp; </label>
                                    <input type="button" name="getSaleData" value="Get"
                                        onclick="getShiftFilterCurrentValue('Asfasf');" id="getSaleData"
                        ...
                        <div id="ledger" class="reportElm" style="display: none;">
                            ...
                            <div class="col-sm-12">
                                <label class="rdolb lh-25"><input type="radio" name="leaderFor" onclick="" value=""
                                        checked>All</label>
                            </div>

                            <div class="col-sm-3">
                                <label class="rdolb lh-25"><input type="radio" name="leaderFor" onclick=""
                                        value="4">Members</label>
                            </div>

                            <div class="col-sm-3">
                                <label class="rdolb lh-25"><input type="radio" name="leaderFor" onclick=""
                                        value="2">Customers</label>
                            </div>

                            <div class="col-sm-3">
                                <label class="rdolb lh-25"><input type="radio" name="leaderFor" onclick="" value="6">Milk
                                    Plant</label>
                            </div>

                            <div class="col-sm-3">
                                <label class="rdolb lh-25"><input type="radio" name="leaderFor" onclick=""
                                        value="3">Suppliers</label>
                            </div>

                            <div class="col-sm-3">
                                <label> &nbsp; </label>
                                <input type="button" name="getLaderData" value="Get"
                                    onclick="getLedgerFilterCurrentValue();" id="getLaderData"
                                    class="getLaderData form-control getButton">
                            </div>
                        ...
                        <div id="memberPassbook" class="reportElm" style="display: none;">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input form="form1"  id="memberCodeP" class="form-control" name="partyCode" required data-name="code">
                            </div>

                            <div class="col-sm-3">
                                <label>Member Name</label>
                                <span class="memberNameErrorMessage errorMessage" id="memberNameErrorMessageP"></span>
                                <input class="form-control" id="memberNameStP" name="partyName" required="true"
                                    data-name="name">
                            </div>

                            <div class="col-sm-3">
                                <label> Start Date </label>
                                <input form="form1" type="text" name="memberPassbookStartDate" id="memberPassbookStartDate"
                                    value="{{date(" d-m-Y ")}}" class="memberPassbookStartDate form-control">
                            </div>
                            <div class="col-sm-3">
                                <label> End Date </label>
                                <input form="form1" type="text" name="memberPassbookEndDate" id="memberPassbookEndDate"
                                    value="{{date(" d-m-Y ")}}" class="memberPassbookEndDate form-control">
                            </div>
                            
                            <div class="col-sm-3">
                                <label> &nbsp; </label>
                                <input type="button" name="getSaleData" value="Get"
                                    onclick="getMemberFilterCurrentPassbookValue('Asfasf');" id="getSaleData"
                                    class="getSaleData form-control getButton">
                            </div>
                        ...
                        <div id="payemntRegister" class="reportElm" style="display: none;">
                            ...
                            <div class="col-sm-3">
                                <label> Start Date </label>
                                <input type="text" name="balanceSheetStartDate" id="balanceSheetStartDate"
                                    value="{{date(" d-m-Y ")}}" class="balanceSheetStartDate form-control">
                            </div>
                            <div class="col-sm-3">
                                <label> End Date </label>
                                <input type="text" name="balanceSheetEndDate" id="balanceSheetEndDate"
                                    value="{{date(" d-m-Y ")}}" class="balanceSheetEndDate form-control">
                            </div>
                             <div class="col-sm-3">
                                <label><label> &nbsp; </label>
                                    <input type="checkbox" name="full" id="full" value="1"> Full
                              
                            </div>
                            <div class="col-sm-3">
                                <label> &nbsp; </label>
                                <input type="button" name="getSaleData" value="Get"
                                    onclick="getBalanceSheetValueForTable();" id="getSaleData"
                                    class="getSaleData form-control getButton">
                            </div>

                            <form method="post" action="{{ url('/getBalanceSheetReportPdf') }}">
                                <div id="balanceSheetTableGetButtone">
                                    <p></p>
                                </div>
                            </form>
                        ...
                        <div id="cmSubsidiary" class="reportElm" style="display: none;">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select id="reportSelectcmSubsidiary" class="form-control selectpicker"
                                    data-live-search="true" title="Select Report" req>
                                    <option value="Simple">Simple</option>
                                    <option value="Antyodya">Antyodya</option>
                                    <option value="Complete">Complete</option>
                                </select>
                            </div>

                            <div id="Reporttype" class="col-sm-6">
                                <label> Data Type </label>
                                <select id="select_report" onchange="gettypedata();" class="form-control selectpicker"
                                    data-live-search="true" title="Select Report">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" name="cmSubsidiaryFieldSupName" id="cmSubsidiaryFieldSupName"
                                    class="cmSubsidiaryFieldSupName form-control">
                            </div>
                            <div class="col-sm-6">
                                <label> Field Sup Contact No </label>
                                <input type="number" name="cmSubsidiaryFieldSupContactNo" id="cmSubsidiaryFieldSupContactNo"
                                    class="cmSubsidiaryFieldSupContactNo form-control">
                            </div>
                            <div class="col-sm-3 pt-5" id="amounts">
                                <label> Amount <span id="milid">Cow's Milk</span> </label>
                                <input type="number" name="cmSubsidiaryAmountLow" id="cmSubsidiaryAmountLow"
                                    class="cmSubsidiaryAmountLow form-control">
                            </div>
                            <div class="col-sm-3 pt-5" style="display: none;" id="amounts_more">
                                <label> Amount <span id="rateid1">Buffalo's Milk </span></label>
                                <input type="number" name="cmSubsidiaryAmountHigh" id="cmSubsidiaryAmountHigh"
                                    class="cmSubsidiaryAmountHigh form-control">
                            </div>

                            <div class="col-sm-3 pt-5">
                                <label> Start Date </label>
                                <input type="text" name="cmSubsidiaryStartDate" id="cmSubsidiaryStartDate"
                                    class="cmSubsidiaryStartDate form-control" value="{{date('d-m-Y')}}">
                            </div>
                            <div class="col-sm-3 pt-5">
                                <label> End Date </label>
                                <input type="text" name="cmSubsidiaryEndDate" id="cmSubsidiaryEndDate"
                                    class="cmSubsidiaryEndDate form-control" value="{{date('d-m-Y')}}">
                            </div>
                            ...
                            <div class="col-sm-3 pt-5">
                                <label> &nbsp; </label>
                                <input type="button" name="getSaleData" value="Get"
                                    onclick="getCmSubsidiaryValueForTable();" id="getSaleData"
                                    class="getSaleData form-control getButton">
                            </div>
                        ...
                        <div id="rateChart" class="reportElm" style="display: none;">
                            <div class="col-sm-3">
                                ...
                                <select name="collectionManager" id="collectionManager"
                                    class="collectionManager form-control selectpicker">
                            ...
                            <div class="col-sm-3">
                                <label> &nbsp; </label>
                                <input type="button" name="getRateCardBtn" value="Get" onclick="getRateCardReport(this);"
                                    id="getRateCardBtn" class="getRateCardBtn form-control getButton">
                            </div>
                        </div>
                        ...
                        <div class="reportElm clearfix dnone" id="memStatement">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input class="form-control" id="memberNameSt" name="partyName" required="true"
                                    data-name="name">
                            </div>

                            <div class="col-sm-3 col-md-3">
                                <label>From</label>
                                <input type="text" class="form-control" id="sdate" placeholder="From"
                                    value="{{date(" d-m-Y ")}}" name="fromdate" autocomplete="off">
                            </div>

                            <div class="col-sm-3 col-md-3">
                                <label>To</label>
                                <input type="text" class="form-control" id="tdate" placeholder="To"
                                    value="{{date(" d-m-Y ")}}" name="todate" autocomplete="off">
                            </div>
                            ...
                            <div class="col-sm-3">
                                <label> &nbsp; </label>
                                <input type="button" name="getStatementBtn" value="Get"
                                    onclick="getMemStatementReport(this);" id="getStatementBtn"
                                    class="getStatementBtn form-control getButton">
                            </div>

                        </div>

                        <div class="reportElm clearfix dnone" id="memStatementDetail">

                            <div class="col-sm-3">
                                <label>Member Code</label>
                                <span class="memberCodeErrorMessage errorMessage" id="memberCodeErrorMessage"></span>
                                <input id="memberCode2" class="form-control" name="partyCode" required data-name="code">
                            </div>

                            <div class="col-sm-3">
                                <label>Member Name</label>
                                <span class="memberNameErrorMessage errorMessage" id="memberNameErrorMessage"></span>
                                <input class="form-control" id="memberNameSt2" name="partyName" required="true"
                                    data-name="name">
                            </div>

                            <div class="col-sm-3 col-md-3">
                                <label>From</label>
                                <input type="text" class="form-control" id="sdate2" placeholder="From"
                                    value="{{date(" d-m-Y ")}}" name="fromdate" autocomplete="off">
                            </div>

                            <div class="col-sm-3 col-md-3">
                                <label>To</label>
                                <input type="text" class="form-control" id="tdate2" placeholder="To"
                                    value="{{date(" d-m-Y ")}}" name="todate" autocomplete="off">
                            </div>
                            ...
                            <div class="col-sm-3">
                                <label> &nbsp; </label>
                                <input type="button" name="getStatementBtn" value="Get"
                                    onclick="getMemStatementReportDetail(this);" id="getStatementBtn"
                                    class="getStatementBtn form-control getButton">
                            </div>
                        ...
                        <div class="reportElm clearfix dnone" id="custSalseReport">
                            <div class="col-sm-12 col-md-12">
                                ...
                                <div class="col-sm-3 col-md-3">
                                    <label>From</label>
                                    <input type="text" class="form-control" id="sdateCust" placeholder="From"
                                        value="{{date(" d-m-Y ")}}" name="fromdate" autocomplete="off">
                                </div>

                                <div class="col-sm-3 col-md-3">
                                    <label>To</label>
                                    <input type="text" class="form-control" id="tdateCust" placeholder="To"
                                        value="{{date(" d-m-Y ")}}" name="todate" autocomplete="off">
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <label> &nbsp; </label>
                                    <input type="button" value="Get" onclick="getCustSalseReport(this);"
                                        id="getCustSalseBtn" class="getCustSalseBtn form-control getButton">
                                </div>
                        ...
                        <div class="reportElm clearfix dnone" id="profitLoss">
                            <div class="col-sm-12 col-md-12 p-0">
                                ...
                                <div class="col-sm-3 col-md-3">
                                    <label>From</label>
                                    <input type="text" class="form-control" id="sdateProfit" placeholder="From"
                                        value="{{date(" d-m-Y ")}}" name="fromdate" autocomplete="off">
                                </div>

                                <div class="col-sm-3 col-md-3">
                                    <label>To</label>
                                    <input type="text" class="form-control" id="tdateProfit" placeholder="To"
                                        value="{{date(" d-m-Y ")}}" name="todate" autocomplete="off">
                                </div>

                                <div class="col-sm-3">
                                    <label> &nbsp; </label>
                                    <input type="button" value="Get" onclick="getProfitLossReport(this);"
                                        id="getProfitLossBtn" class="getProfitLossBtn form-control getButton">
                                </div>

                            </div>
                        </div>
                        <div class="reportElm clearfix dnone" id="supplier">
                            <div class="col-sm-12 col-md-12 p-0">

                                <div class="col-sm-3 col-md-3">
                                    <label>Supplier Code</label>
                                    <input type="text" name="mcode" id="suppliercode" class="form-control"
                                        placeholder="Supplier Code" data-name="code">
                                </div>

                                <div class="col-sm-3 col-md-3">
                                    <label>Supplier Name</label>
                                    <input type="text" name="mcode" id="supplierName" class="form-control"
                                        placeholder="Supplier Name" data-name="name">
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <label> &nbsp; </label>
                                    <input type="button" value="Get" onclick="getSupplier(this);" id="getSupplierbtn"
                                        class=" form-control getButton">
                                </div>
        ...
        <script>
            function gettypedata() {
                var select_report = document.getElementById('select_report').value;
                if (select_report == "Combine") {
                    document.getElementById('milid').innerText = "Combine Milk";
                    document.getElementById('amounts_more').style.display = 'none';
                } else {
                    document.getElementById('milid').innerText = "Cow's Milk";
                    document.getElementById('amounts_more').style.display = 'block';
            ...
            $(function () {
                ...
                $("#memberNameSt2").autocomplete({
                    minLength: 0,
                    source: membersName,
                    focus: function (event, ui) {
                        $("#memberNameSt2").val(ui.item.label);
                        return false;
                    },
                    select: function (event, ui) {
                        $("#memberCode2").val(ui.item.desc);
                        $("#memberNameSt2").val(ui.item.value);
                        // SetMemberCode();
                        return false;
                    }
                }).autocomplete("instance")._renderItem = function (ul, item) {
                ...
                var supp = [
                    @foreach($returnData[3] as $s) {
                            value: "{{ $s->supplierCode }}",
                            label: "{{ $s->supplierCode }}",
                            desc: "{{ $s->supplierFirmName }}",
                        },
                    @endforeach
                ];
                ...
                var suppName = [
                    @foreach($returnData[3] as $s) {
                            value: "{{ $s->supplierFirmName }}",
                            label: "{{ $s->supplierFirmName }}",
                            desc: "{{ $s->supplierCode }}",
                        },
                    @endforeach
                ];
            ...
            $("#memberCode2, #memberNameSt2").on("change, focusout", function () {
                v = $(this).val();
                if (v == (null || '')) {
                    return false;
                }
                getUserDetail(v, this, $(this).data("name"), "memberDetail", "");
            })
            ...
            function setUserData(data, elm, user, no) {
                ...
                if (user == "memberDetail") {
                    $("#memberCode2" + no).val(data.code);
                    $("#memberNameSt2" + no).val(data.name);
                    $("#memberCode2" + no + ", #memberNameSt2" + no).removeClass("has-error");
                }
                ...
                if (user == "supplier") {
                    ...
                    $("#suppliercode, #supplierName").removeClass("has-error");
                }
            ...
            function getReportForm(reportKey) {
                ...
                $(".reportElm").hide();
                $("#" + reportKey).show();
                window.history.pushState("", reportKey, "{{url('getReport?type=')}}" + reportKey);
            ...
            $(function () {
                $('#saleStartDate, #saleEndDate, #shiftDate, #memberPassbookStartDate, #memberPassbookEndDate, #balanceSheetStartDate, #balanceSheetEndDate, #cmSubsidiaryEndDate, #cmSubsidiaryStartDate, #tdate, #sdate,#tdate2, #sdate2, #sdateCust, #tdateCust, #sdateProfit, #tdateProfit, #fromdate,#todate').datetimepicker({
                    format: 'DD-MM-YYYY'
                });
            });
            ...
            function pdfFunction(doc) {
                ...
                doc.styles.tableHeader.fillColor = doc.styles.tableFooter.fillColor = '#fff';
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        table = $('.sales-table').DataTable({
                            ...
                            //     footer: true,
                            //     extend: 'pdfHtml5',
                            //     filename: res.headings.report + " (from "+res.headings.from+" to "+res.headings.to+")",
                            ...
                            //             g["headings"].text = "\n from "+ g['headings'].from+ " to " + g['headings'].to;
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        table = $('.shift-summary-table').DataTable({
                            ...
                            //     footer: true,
                            //     extend: 'pdfHtml5',
                            //     filename: res.headings.report + " (date "+res.headings.shiftDate+" "+res.headings.shiftType+")",
                            //     orientation: 'portrait', //landscape
                            //     pageSize: 'A4', //A3 , A5 , A6 , legal , letter
                            //     exportOptions: {
                            //         columns: ':visible',
                            ...
                            //     },
                            //     customize: function (doc) {
                            //             g["headings"].text = "\n date "+ g['headings'].shiftDate +" "+g['headings'].shiftType;
                            ...
                            // },
                            {
                                extend: 'excel',
                                footer: true,
                                messageTop: g['headings'].dairyName + "(" + g['headings'].society_code + ") \n " + g['headings'].report + " \n date " + g['headings'].shiftDate + " shift " + g['headings'].shiftType
                            }
                            ]
                        });
            ...
            function getBalanceSheetValueForTable() {
                ...
                var full = $("#full").is(":checked") ? $("#full").val() : "";

                $.ajax({
                    type: "post",
                    url: 'getBalanceSheetReport',
                    data: {
                        dairyId: dairyId,
                        status: status,
            ...
            function getCmSubsidiaryValueForTable() {
                ...
                var status = $("#status").val();
                var select_report = document.getElementById("select_report").value;
                var reportSelectcmSubsidiary = document.getElementById("reportSelectcmSubsidiary").value;
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        reportSelectcmSubsidiary: reportSelectcmSubsidiary,
            ...
            //             fileName: "CMSubsidyReport_{{$dairy->dairyName}}"
            //         },
            //         success:function(res){
            //             loader("hide");
            //         }
            ...
            function getMemStatementReportDetail() {
                loader("show");

                var dairyId = $("#dairyId").val();
                var status = $("#status").val();

                var memberCode = $("#memberCode2").val();
                var memberName = $("#memberNameSt2").val();
                var startDate = $("#sdate2").val();
                var endDate = $("#tdate2").val();
                var groupByDate = $("#groupByDate").val();

                $.ajax({
                    type: "post",
                    url: '{{url('getMemStatementReport2')}}',
                    data: {
                        dairyId: dairyId,
                        status: status,
                        memberCode: memberCode,
                    ...
                    success: function (res) {
                        ...
                        $("#table-data").html(res.content).addClass("table-back");
                        g['headings'] = res.headings
                        table = $('.memStatement3-table').DataTable({
                            "sScrollX": "100%",
                            "sScrollXInner": "100%",
                            "dom": '<"dt-buttons"Bf><"clear">lirtp',
                            "paging": true,
            ...
            function getCustSalseReport() {
                ...
                $.ajax({
                    type: "post",
                    url: '{{url('getCustomerSalseReport')}}',
                    data: {
                        dairyId: dairyId,
                        status: status,
            ...
            function getSupplier() {
                ...
                var dairyId = $("#dairyId").val();
                var status = $("#status").val();
                var scode = $("#suppliercode").val();
                var from = $("#fromdate").val();
                var to = $("#todate").val();
                $.ajax({
                    type: "post",
                    url: '{{url('getSupplierReport ')}}',
                    data: {
                        dairyId: dairyId,
                        status: status,
                        startDate: from,
                    ...
                    success: function (res) {
                        ...
                        table = $('.supplierSttTable').DataTable({
                            "sScrollX": "100%",
                            "sScrollXInner": "100%",
                            "ordering": false,
                            "dom": '<"dt-buttons"Bf><"clear">lirtp',
