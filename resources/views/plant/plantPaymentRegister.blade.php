    ...
    <div class="upper-controls clearfix">
        ...
        <div class="mb-20 clearfix">
            ...
            <div class="col-md-12">
                ...
                <div class="col-sm-4 col-md-4 pull-right col-lg-3">
                    <label> &nbsp; </label>
                    <input type="button" name="getMemberList" value="Get" onclick="getPayment(event);" id="getPayment" class=" form-control getButton btn-primary">
                </div>
            </div>
            <br>
    ...
    <table id="MyTable" class="table table-bordered" cellspacing="0" width="100%">
        ...
        <tfoot>
            <tr style="font-weight:bolder;background: #e4e4e4;">
                ...
                @endif
                <td style="font-family:'DejaVu Sans', sans-serif;text-align:right">&#8377; {{$total}}</td>
...
<script>
    ...
    function getPayment(event) {
        ...
        // if (society_code == null || society_code == "") {
        //     var url = "{{url('plant/paymentRegister')}}";
