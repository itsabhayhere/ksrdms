...
<div class="col-md-12 rateChart" >
    ...
    <div class="upper-controls pt-0 clearfix">
        ...
        <div class="fr">
            ...
            <form action="{{url('api/applyRatecard')."?device_token=".$device_token}}" method="post" class="fl ms-20">
    ...
    <table class="table rateChartTable table-bordered table-striped sticky-header nowrap" style="width:100%">
...
@endphp
                        ...
                        <td class="tr @if($rate->updated_at!=null) updated_cell @endif">
                            ...
                            <input type='number' class="input" value='{{number_format($rate->amount, 2, ".", "")}}' data-fat='{{number_format($rate->fatRange, 2)}}'

                                data-snf='{{number_format($rate->snfRange, 2)}}' data-fixrate="{{number_format($rate->amount, 2)}}"
...
$(document).ready(function() {
    ...
    var rateChartTable = $(".rateChartTable").DataTable({
    ...
    // new $.fn.dataTable.FixedHeader(rateChartTable);
    ...
    window.rateChart.device_token = "{{$device_token}}";
