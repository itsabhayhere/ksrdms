...
@endphp <style
    ...
    <div class="wmodel clearfix" id="dateShiftPopup">
        ...
        <div class="wmodel-body">
            ...
            <div class="col-sm-12">
                <div class="col-sm-6">
                    <label>Date</label>
                    <input type="text" class="form-control" id="sdate" placeholder="Date" value="{{date(" d-m-Y ", strtotime($date))}}" name="date"
    ...
    <div class="pageblur">
        ...
        <div class="clearfix">
            ...
            <div class="fcard margin-fcard-1 pt-0 clearfix">
                <div class="heading clearfix">
                    ...
                    <div class="fr">
                        @if($mUtility->isActive != 0 || $wUtility->isActive != 0)
                            <label for="">Automatic Reading enabled for @if($mUtility->isActive) Fat @endif @if($mUtility->isActive && $wUtility->isActive) and @endif @if($wUtility->isActive) Weight @endif</label>
                            {{-- <div class="checkbox">
                                <label><input type="checkbox" class="checkbox" value="" id="autometicReadingCheck">Temporary disable autometic reading from scale</label>
                            </div> --}}
                        @endif
                    </div>
                </div>
                ...
                <div class="clearfix">
                    <form method="post" action="{{ url('/DailyTransactionSubmit') }}" class="clearfix" id="dailyForm" autocomplete="off">
                        ...
                        <div class="col-md-12 clearfix" style="background: #f6f7f9;padding: 10px 15px;border: 1px solid #dedede;">
                            ...
                            <div class="col-sm-3">
                                <div id="SetShiftField" class="SetShiftField">
                                    <label>Shift: <b><input type="text" class="noinput" id="dailyShift" value="{{ucfirst($curShift)}}" name="dailyShift" readonly size="9"></b></label>
                                </div>
                            </div>
                            <div class="col-md-3">
                        ...
                        <div class="col-sm-12 reset-fields">
                            ...
                            <div class="col-sm-3 m-0 @if($ratecardtype == "fat") dnone @endif" id="rateForRateCardSnf">
                                <label>SNF</label>
        ...
        <div class="wmodel-body">
            ...
            <div class="p-5-20">
                ...
                <form method="post" action="{{ url('/updateTransaction') }}" class="clearfix" id="dailyForm2">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <input type="hidden" id="dairyId3" name="dairyId" value="{{ Session::get('loginUserInfo')->dairyId }}">
                    <input type="hidden" name="status" value="true">
    ...
    glbl['manual_entry_fat'] = !{{$mUtility->isActive}};
    glbl['manual_entry_weight'] = !{{$wUtility->isActive}};
