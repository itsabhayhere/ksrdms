...
<div class="fcard margin-fcard-1 pt-0 clearfix">
    <div class="upper-controls clearfix">
        <div class="fl">
            <h3>Milk Collection Request</h3>
        </div>
        <div class="fr">
            <select class="selectpicker show-menu-arrow pull-right" name="deliveryType" id="deliveryType">
    ...
    <div class="col-sm-12 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1">
        ...
        <div class="member @if($m->isDeliverd == 1) req-completed @elseif($m->isDeliverd == 2) req-decliend  @endif" id="milkreq{{$m->id}}">
...
<script>
        ...
        $.ajax({
            ...
            success:function(res){
                if(res.error){
                    ...
                    if(action=="complete"){
                        res.msg = "Milk Request completed, For milk collection go to <a href='{{url('DailyTransactionForm')}}'>Milk Collection</a>";
    ...
    $("#deliveryType").on("change", function(){
        ...
        window.location.assign("{{url('milkRequest')}}"+"?deliveryType="+deliveryType);
    })
</script>
@endsection