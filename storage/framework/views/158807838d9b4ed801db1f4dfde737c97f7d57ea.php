...
<footer class="footer footer-big">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="ksr-logo">
                    <img src="<?php echo e(asset('images/pdfLogo.png')); ?>" class="img-responsive" alt="">
                </div>
                <h3>KSR Services</h3>
                <p>VPO Banwala</p>
                <p>Tehsil Dabwali</p>
            ...
            <div class="col-md-3 section-fotter">
                ...
                <ul>
                    ...
                    <li><a href="<?php echo e(url('termsCond')); ?>">Terms and Conditions</a></li>
                    <li><a href="<?php echo e(url('privacyPolicy')); ?>">Privacy Policy</a></li>
                    <li><a href="<?php echo e(url('refund')); ?>">Refund & Cancellation</li>
                        <li><a href="<?php echo e(url('disclaimer')); ?>">Disclaimer</li>
            ...
            <div class="col-md-3 section-fotter">
                ...
                <div class="w-80">
                    <a href="https://www.ccavenue.com/" target="_blank">
                        <img src="<?php echo e(asset('images/ccavenue.png')); ?>" alt="ccAvenue" class="img-responsive">
                    </a>
            </div>
