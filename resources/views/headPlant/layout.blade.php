            ...
            <nav class="navbar navbar-default" role="navigation" style="margin-bottom: 52px;">
                ...
                <div class="side-menu-container">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dashboard"><a href="{{url('headPlant/dashboard')}}"><span class="fa fa-dashboard"></span> Home</a></li>
                        
                        {{-- <li class="request"><a href="{{url('headPlant/requestToAdd')}}"><span class="fa fa-plus-square"></span>Verify Dairies</a></li> --}}

                        {{-- <li class="dairies"><a href="{{url('headPlant/dairies')}}"><span class="fa fa-plus-square"></span>Dairies</a></li> --}}
                        <li class="dairies"><a href="{{url('headPlant/alldairies')}}"><span class="fa fa-plus-square"></span>Dairies</a></li>

                        @if(session()->get("plantInfo")->isMainPlant)

                            <li class="plants"><a href="{{url('headPlant/plants')}}"><span class="fa fa-plus-square"></span>Plants</a></li>
                            ...
                            <li class="panel panel-default report " id="dropdown">
                                ...
                                <div id="dropdown-report" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ul class="nav navbar-nav">
                                            <li class="dairy_report"><a href="{{url('headPlant/allmember')}}">Member Report</a></li>
                                            <li class="payment_register"><a href="{{url('headPlant/payment_register')}}">Payment Register</a></li>
                                            <li class="shift_report"><a href="{{url('headPlant/shift_summary')}}">Shift Summary</a></li>
                                            <li class="cm_report"><a href="{{url('headPlant/cm_subsidiary')}}">CM Subsidiary</a></li>
                                        </ul>
                                    </div>
                                </div>
