...
<body>
    ...
    @php 
        if(isset(Auth::user()->name)) $brand = Auth::user()->name; 
        elseif(isset(Session::get('loginUserInfo')->supplierFirmName)) $brand = Session::get('loginUserInfo')->supplierFirmName; 
        else $brand = "DMS"; 
        // dd(Session::all());
    @endphp
            ...
            <nav class="navbar navbar-default" role="navigation" style="margin-bottom: 52px;">
                    ...
                    <div class="brand-wrapper">
                        ...
                        <div class="brand-name-wrapper">
                            <a class="navbar-brand" href="DairyAdminDashbord">
                                {{$brand}}
                                @if(isset(Session::get('loginUserInfo')->supplierCode))
                                    <br>
                                    <span style="font-size:13px;">
                                        Supplier Code: {{Session::get('loginUserInfo')->supplierCode}}
                                    </span>
                                @endif
                            </a>
                        </div>
                ...
                <div class="side-menu-container">
                    <ul class="nav navbar-nav" >
                        ...
                        <li class="dashboard"><a href="{{url('member/dashboard')}}"><span class="fa fa-plus-square"></span> Home</a></li>
                        {{-- <li class="dairyList"><a href="{{url('member/collectionHistory')}}"><span class="fa fa-list-alt"></span> Daily Transactions </a></li>
