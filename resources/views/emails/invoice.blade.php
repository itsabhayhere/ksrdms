        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" class="content" style="background-color: #FFFFFF">
          <tr>
            <td id="templateContainerHeader" valign="top" mc:edit="welcomeEdit-01">
              <p style="text-align:center;margin:0;padding:0;"><img src="{{asset('images/logo_90x45.jpg')}}" style="display:inline-block;"></p>
            </td>
          </tr>
              ...
              <table border="0" cellpadding="0" cellspacing="0" class="brdBottomPadd-two" id="templateContainer" width="100%">
                <tr>
                  <td class="bodyContent" valign="top" mc:edit="welcomeEdit-02">
                    ...
                    <h1><strong>Congratulations! <br>
                    Your plan is activated. </strong></h1>

                    <h3>
                        You have successfully extend your validity of your DMS subscription.
                    </h3>
                    <p>
                        ...
                        <table class="f-12">
                            ...
                            <tr>
                                ...
                                <td>: <strong>{{$expieryDate}}</strong></td>
                            </tr>
                        </table>

                      {{-- Your can login now to your dairy dashboard. <br /> Login link: <a href="{{$loginlink}}" target="_blank"> Login </a>                      <br /> User Id: <b>{{$user['id']}}</b> <small>(Your Mobile No.)</small> <br/> Pass: <b>{{$user['pass']}}</b> --}}
                    </p>
                    <br>
                    <p>
                        Please download your invoice by login to your dairy account.
                    </p>
                    <p>
                      <a href="{{url("downloadFiles")."?file=".$invoiceFile}}">Download Invoice </a>
                    </p>
                  </td>
                </tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="left" style="margin:0;padding:0;" valign="top" width="50" mc:edit="welcomeEdit-03">
                          ...
                          <p style="margin-bottom:10px"><img src="{{asset('images/user.png')}}" style="display:block;border-radius: 54%;border: 2px solid #eaeaea;padding: 0 3px;width: 50px;"></p>
                        </td>
                        ...
                        <td align="left" style="margin:0;padding-top:10px;line-height:1;" valign="top" mc:edit="welcomeEdit-04">
                          <h4><strong>{{$dairyAdmin}}</strong></h4>

                          <h5>DMS Administrator</h5>
                        </td>
                      </tr>
                    </table>
                  </td>
              ...
              <table border="0" cellpadding="0" cellspacing="0" id="templateContainerFooter" width="100%">
                <tr>
                  <td valign="top" width="100%" mc:edit="welcomeEdit-11">
                    <p style="text-align:center;"><img src="{{asset("images/flask.jpg")}}" style="margin:0 auto 0 auto;display:inline-block;height: 30px;filter: grayscale(1);"></p>

                    <h6 style="text-align:center;margin-top: 9px;">Powered by<a href="http://techpathway.com"> Tech Pathway</a></h6>

                    {{-- <h6 style="text-align:center;">2nd Floor, 72/261A, &#8203; Vinayak Path, Mansarovar, &#8203;</h6>

                    <h6 style="text-align:center;">Jaipur, &#8203; Rajasthan &#8203; 302020&#8203;</h6> --}}
