...
<?php $__env->startSection('content'); ?> <?php if (session()->has('dailyTransactionDate')) { $date = session()->get('dailyTransactionDate');
$flag = 0;}else{ $date = date("d-m-Y"); $flag = 1;} if (session()->has('dailyTransactionShift')) { $curShift = session()->get('dailyTransactionShift');
if($flag)$flag=0;} else{ if (date("H", time())
< 12) $curShift="morning" ; else $curShift="evening" ; $flag=1;}
?> <style
    type="text/css">
    ...
    <div class="wmodel clearfix" id="dateShiftPopup">
        ...
        <div class="wmodel-body">
            ...
            <div class="col-sm-12">
                <div class="col-sm-6">
                    <label>Date</label>
                    <input type="text" class="form-control" id="sdate" placeholder="Date" value="<?php echo e(date(" d-m-Y ", strtotime($date))); ?>" name="date"
                ...
                <div class="col-sm-6">
                    <div id="SetShiftField" class="SetShiftField">
                        ...
                        <option value="morning" <?php if($curShift=="morning"): ?>selected <?php endif; ?>> Morning Shift </option>
                        <option value="evening" <?php if($curShift=="evening"): ?>selected <?php endif; ?>> Evening Shift </option>
                    </select>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12 text-center pt-20">
                <a href="#" role="button" class="btn btn-primary" id="date-shift-btn" onclick="fetch_transactions_by_date(this); $('#memberCode').trigger('change')">Fetch Transactions</a>
            </div>
        ...
        <div class="clearfix">
            ...
            <div class="fcard margin-fcard-1 pt-0 clearfix">
                <div class="heading clearfix">
                    ...
                    <div class="fr">
                        <?php if($mUtility->isActive != 0 || $wUtility->isActive != 0): ?>
                            <label for="">Automatic Reading enabled for <?php if($mUtility->isActive): ?> Fat <?php endif; ?> <?php if($mUtility->isActive && $wUtility->isActive): ?> and <?php endif; ?> <?php if($wUtility->isActive): ?> Weight <?php endif; ?></label>
                ...
                <div class="clearfix">
                    <form method="post" action="<?php echo e(url('/DailyTransactionSubmit')); ?>" class="clearfix" id="dailyForm" autocomplete="off">
                        ...
                        <div class="col-md-12 clearfix" style="background: #f6f7f9;padding: 10px 15px;border: 1px solid #dedede;">
                            <div class="col-sm-3">
                                <label>Date: <b><input type="text" class="noinput" id="date" value="<?php echo date(" d-m-Y ") ; ?>" name="date" readonly></b></label>
                            </div>
                            <div class="col-sm-3">
                                Morning Shift Collection: <b id="msc"><?php echo e($msc); ?></b>
                                <br> Evening Shift Collection: <b id="esc"><?php echo e($esc); ?></b>
                            </div>
                            <div class="col-sm-3">
                                <div id="SetShiftField" class="SetShiftField">
                                    <label>Shift: <b><input type="text" class="noinput" id="dailyShift" value="<?php echo e(ucfirst($curShift)); ?>" name="dailyShift" readonly size="9"></b></label>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <a href="#" role="button" class="btn btn-primary btn-sm" id="" onclick="show_popUp(this)">Change date & shift</a>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 reset-fields">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input id="memberCode" class="form-control" required name="memberCode" tabindex="1" data-name="code" autocomplete="off" placeholder="Member Code" onkeydown="memCodeInputEvent(event, this, $('#quantity'))">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="text" required="true" class="form-control" placeholder="Enter Quantity" id="quantity" name="quantity" tabindex="2" autocomplete="off" onkeydown="qtyInputEvent(event, this, $('#fatSnf_fatValue'))">
                            </div>


                            <div class="col-sm-3 m-0" id="rateForRateCardFat">
                                <label>Fat</label>
                                <input type="number" class="form-control" placeholder="Enter Fat" id="fatSnf_fatValue" name="fat" required step="0.05" tabindex="3" autocomplete="off" onkeydown="fatInputEvent(event, this)">
                            </div>
                            <div class="col-sm-3 m-0 <?php if($ratecardtype == "fat"): ?> dnone <?php endif; ?>" id="rateForRateCardSnf">
                                <label>SNF</label>
                                <input type="number" class="form-control" placeholder="Enter Snf" id="fatSnf_snfValue" name="snf" step="0.1" tabindex="4" autocomplete="off">
                            </div>
                        ...
                        <div class="col-sm-12 reset-fields">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input id="memberName" type="text" name="memberName" class="form-control" required data-name="name" autocomplete="off" placeholder="Member Name">
                            </div>

                            <div class="col-sm-3 pt-30">
                                <label>Milk Type:
                                <b><input type="text" class="noinput" name="milkType" id="milkType" readonly value="Select Member" size="12"></b>
                            </label>
                            </div>

                            <div class="col-sm-3 pt-30">
                                <label>Rate: 
                                <b><input type="text" class="noinput" value="" name="price" id="price" readonly value="0.0" size="8"></b>
                            </label>
                            </div>
                            ...
                            <div class="col-sm-3">
                                ...
                                <input required="true" type="text" class="form-control" placeholder="Enter Amount" id="amount" name="amount" readonly>
                            </div>
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div class="col-sm-9">
                                <button type="submit" name="submit" class="btn btn-primary" id="dailySubmitBtn" tabindex="5" disabled>Add Transaction</button>
                                <img src="<?php echo e(asset('images/loading.gif')); ?>" alt="" class="loading-on-btn dnone">
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="wmodel clearfix" id="editTransModel" style="width: 75%;">
        ...
        <div class="wmodel-body">
            ...
            <div class="p-5-20">
                ...
                <form method="post" action="<?php echo e(url('/updateTransaction')); ?>" class="clearfix" id="dailyForm2">
                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                    <input type="hidden" id="dairyId3" name="dairyId" value="<?php echo e(Session::get('loginUserInfo')->dairyId); ?>">
                    <input type="hidden" name="status" value="true">
                    <input type="hidden" id="date3" value="<?php echo e(date(" d-m-Y ", strtotime($date))); ?>" name="date" readonly>
                    <input type="hidden" id="dailyShift3" value="" name="dailyShift">
                    <input type="hidden" id="action3" value="replace" name="action" comment="decide what to do, new, replace">
                    <input type="hidden" id="dailyTransactionId3" value="" name="dailyTransactionId" comment="In replace condition">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="text" class="form-control" id="memberCodeInputHidden3" name="memberCode" value="" readonly tabindex="11">
                        </div>

                        <div class="col-sm-3">
                            <label>Quantity</label>
                            <input type="text" required="true" class="form-control" id="quantity3" onchange="callValues2()" placeholder="Enter Quantity"
                                name="quantity" tabindex="12" autocomplete="off">
                        </div>

                        <div class="col-sm-3 m-0" id="rateForRateCardFat3">
                            <label>Fat</label>
                        <input type="number" class="form-control" placeholder="Enter Fat" id="fatSnf_fatValue3" name="fat" required step="0.05" tabindex="13" autocomplete="off" >
                        </div>
                        <div class="col-sm-3 m-0 dnone" id="rateForRateCardSnf3">
                            <label>SNF</label>
                            <input type="number" class="form-control" placeholder="Enter Snf" id="fatSnf_snfValue3" name="snf" step="0.1" tabindex="14" autocomplete="off">
                        </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-6 pt-30 text-center">
                            <div class="col-sm-6">
                                <label>Milk Type:
                                <b>
                                    <input type="text" class="noinput" name="milkType" id="milkType3" readonly value="$info->milkType" size="12">
                                </b>
                            </label>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <label>Rate: 
                                <b>
                                    <input type="text" class="noinput" value="" id="price3" name="price" readonly value="0.0" size="8">
                                </b>
                            </label>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <label>Amount</label>
                            <input required="true" type="text" class="form-control" id="amount3" placeholder="Enter Amount" name="amount" readonly tabindex="15">
                        </div>
                    ...
                    <div class="col-sm-12 text-center">
                        <div class="pt-30"></div>
                        <button type="submit" name="submit" id="transBtn3" class="btn btn-primary" tabindex="17">Update</button>
                        <div class="fr"><a href="#" role="button" onclick="closeTransEdit(event)" class="btn btn-info" tabindex="18">Cancel</a></div>
                    </div>
                </form>
            </div>
        </div>
    ...
    glbl['autoFillMilk'] = glbl['autoFillMilk_ini'] = <?php echo e($mUtility->isActive); ?>;
    glbl['autoFillWeight'] = glbl['autoFillWeight_ini'] = <?php echo e($wUtility->isActive); ?>;
    glbl['tmp_oldFatVal'] = 0;
    glbl['tmp_oldWeightVal'] = 0;
    glbl['manual_entry_fat'] = !<?php echo e($mUtility->isActive); ?>;
    glbl['manual_entry_weight'] = !<?php echo e($wUtility->isActive); ?>;
    ...
    var dairyId = document.getElementById("dairyId").value;
                                        ...
                                        $( function() {
                                            ...
                                            var members = [
                                                <?php $__currentLoopData = $memberInfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    {
                                                        value: "<?php echo e($mem->memberPersonalCode); ?>",
                                                        label: "<?php echo e($mem->memberPersonalCode); ?>",
                                                        desc: "<?php echo e($mem->memberPersonalName); ?>",
                                                    },
                                            ...
                                            var memberNames = [
                                                <?php $__currentLoopData = $memberInfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    {
                                                        value: "<?php echo e($mem->memberPersonalName); ?>",
                                                        label: "<?php echo e($mem->memberPersonalName); ?>",
                                                        desc: "<?php echo e($mem->memberPersonalCode); ?>",
                                                    },
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            ];
            ...
            $.confirm({
                ...
                buttons: {
                    addMember: {
                        ...
                        btnClass: 'btn-orange',
                        action: function(){
                            window.location = "<?php echo e(url('memberSetupForm')); ?>";
                        }
                    }
                }
            });
            ...
            $.confirm({
                ...
                buttons: {
                    addMember: {
                        ...
                        btnClass: 'btn-orange',
                        action: function(){
                            window.location = "<?php echo e(url('rateCardNew')); ?>";
                        }
                    }
                }
            });
    ...
    $("#sdate").on("dp.change", function(){
        ...
        $("#date").val($(this).val());
        url = "<?php echo e(url('/DailyTransactionSubmit')); ?>?date="+$("#sdate").val()+"&shift="+$("#sdailyShift").val();
    ...
    function changeUrl(){
        ...
        if(document.location.href.indexOf('?') != -1) {
            var url = "<?php echo e(url('/DailyTransactionForm')); ?>"+"?"+param;
        }else{
            var url = "<?php echo e(url('/DailyTransactionForm')); ?>"+"?"+param;
        }
  ...
  /* get member code by member name */
            ...
            if(memberCode!= ""){
                ...
                $.ajax({
                    ...
                    success:function(res){
                        ...
                        if(res.error){
                            $("#response-alert").html(res.msg).show();
                            setTimeout(function (e){ $("#da").fadeOut('slow');}, 8000);
    ...
    $("#milkPortBtn").on("click", function(){
        ...
        var data = {
            portName: '<?php echo e($mUtility->communicationPort); ?>',
            baudRate: '<?php echo e($mUtility->maxSpeed); ?>',
            parity:   '<?php echo e($mUtility->connectionPerferenceParity); ?>',
            dataBits: '<?php echo e($mUtility->connectionPerferenceDataBits); ?>',
            stopBits: '<?php echo e($mUtility->connectionPerferenceStopBits); ?>',
            startChars: ['$'],
            endChars: ['\n', '\r'],
        };
    ...
    function memCodeInputEvent(e, code, qty){
...
function qtyInputEvent(e, elm, fat){
    console.log(e.which);
    quantityVal();
    ...
    function getQtyWeightFromPort(elm){
        ...
        var data = {
            portName: '<?php echo e($wUtility->communicationPort); ?>',
            baudRate: '<?php echo e($wUtility->maxSpeed); ?>',
            parity:   '<?php echo e($wUtility->connectionPerferenceParity); ?>',
            dataBits: '<?php echo e($wUtility->connectionPerferenceDataBits); ?>',
            stopBits: '<?php echo e($wUtility->connectionPerferenceStopBits); ?>',
            saparator: '$',
            startChars: ['$'],
            endChars: ['\n', '\r'],
            decimal_digit: "<?php echo e($wUtility->decimal_digit); ?>",
        };
        ...
        $.ajax({
            ...
            success: function (resp) {
                ...
                resp = truncateToDecimals(parseFloat(resp), data.decimal_digit);
                
                $("#quantity, #quantity2, #quantity3").val(resp);
                
                if(resp!=glbl['tmp_oldWeightVal']){
                    $("#quantity").trigger('input');
                    $("#quantity2").trigger('input');
                    $("#quantity3").trigger('input');
                }
        ...
        $.ajax({
            ...
            success: function (resp) {
                ...
                if(resp!=glbl['tmp_oldFatVal']){
                    $("#fatSnf_fatValue").trigger('input');
                    $("#fatSnf_fatValue2").trigger('input');
                    $("#atSnf_fatValue3").trigger('input');
                }
...
document.getElementById('quantity').addEventListener('input', function () {
    ...
    debounceTimer = setTimeout(() => {
        ...
        if (number > 20) {
            const confirmResult = confirm("Quantity is greater than 20. Confirm?");
            if (!confirmResult) {
                this.value = '';
            }
        }
...
function quantityVal() {
    const qtyInput = document.getElementById('quantity2');
    if (!qtyInput) return;
    ...
    qtyInput.addEventListener('input', function () {
        ...
        debounceTimer = setTimeout(() => {
            ...
            console.log("Quantity entered at:", timeString);
